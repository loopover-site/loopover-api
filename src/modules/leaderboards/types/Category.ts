...
type SubCategoryBase = "regular" | "mo3" | "ao5" | "blindAo5" | "blind" | "fmc" | "nrg"

export const categories: Record<Category, SubCategoryBase[]> = {
    "3x3": ["blindAo5"],
...
export type SubCategory<T extends Category> = ValueOf<typeof categories[T]>;
